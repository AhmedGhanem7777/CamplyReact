...
// const plans = [
//   { id: 'basic', title: 'أساسي', price: 'مجاني', features: ['عرض مخيم واحد', 'دعم عبر البريد'] },
//   { id: 'pro', title: 'احترافي', price: '99 ر.س / شهر', features: ['حتى 5 مخيمات', 'أولوية في البحث', 'شارة مميزة'] },
//   { id: 'biz', title: 'أعمال', price: '299 ر.س / شهر', features: ['غير محدود', 'مدير حساب', 'دعم أولوية'] },
// ];

// export default function Pricing() {
//   const salesPhone = '9665ZZZZZZZZ';
//   const subscribe = (title: string) => window.open(waLink(salesPhone, `أرغب في الاشتراك في باقة ${title}`), '_blank');
//   return (
//     <div className="container py-16">
//       <h1 className="text-3xl font-bold mb-8">باقات الاشتراك</h1>
//       <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
//         {plans.map(pl => (
//           <div key={pl.id} className="border rounded-xl p-6 bg-background">
//             <h3 className="text-xl font-semibold mb-2">{pl.title}</h3>
//             <div className="text-2xl font-bold mb-4">{pl.price}</div>
//             <ul className="space-y-2 mb-6">{pl.features.map(f => <li key={f}>• {f}</li>)}</ul>
//             <button onClick={() => subscribe(pl.title)} className="w-full h-11 rounded-lg bg-[#25D366] text-white">اشترك عبر واتساب</button>
//           </div>
//         ))}
//       </div>
//     </div>
