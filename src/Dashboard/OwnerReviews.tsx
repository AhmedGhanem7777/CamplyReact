...
//         return comment.includes(q) || email.includes(q);
//       })
//       .sort((a, b) => {
...
//                 <Input placeholder="بحث في التعليقات أو الإيميل..." value={search} onChange={(e) => { setSearch(e.target.value); setPageIndex(1); }} className="pr-10" />
//               </div>
...
//                       <TableHead className="text-right">النجوم</TableHead>
...
//                         <TableCell className="font-medium">{(pageIndex - 1) * pageSize + i + 1}</TableCell>
//                         <TableCell>
//                           <div className="flex items-center gap-1">
//                             {Array.from({ length: r.stars }).map((_, k) => <Star key={k} className="h-4 w-4 text-yellow-500 fill-yellow-500" />)}
//                             {Array.from({ length: Math.max(0, 5 - r.stars) }).map((_, k) => <Star key={`o-${k}`} className="h-4 w-4 text-muted-foreground" />)}
//                           </div>
//                         </TableCell>
...
//                           </ScrollArea>
//                         </TableCell>
//                         <TableCell>{r.createdOn ? new Date(r.createdOn).toLocaleString("ar-SA") : "-"}</TableCell>
//                       </TableRow>
//                     ))}
//                   </TableBody>
//                 </Table>
